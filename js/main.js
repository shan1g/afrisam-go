...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function setDefaults() {
        ...
        $(window).scroll(function() {
            if ($(window).scrollTop() > 1000 && $(window).scrollTop() < 2500 ) {
                btn.addClass('show');
                btn.removeClass('minimise');
            }
            else if ($(window).scrollTop() > 2500) {
                btn.addClass('show');
                btn.addClass('minimise');
            }
        ...
        if (isMobile != null && scrWidth <= 540 || scrWidth < 540) {
        ...
        else if (isMobile != null || isiPad != null && scrWidth < 990 || isMobile != null && scrWidth == 1280 || scrWidth < 1280) {
            $(window).on("orientationchange", function (event) {
                if (window.orientation == 90 || window.orientation == -90) {
                    location.reload();
                } else {
